...
UNITS = [
    ...
    Unit("mukashi", "その空白は、3ヶ月だと聞いたことがないだろうか。", anim=1.4,
         face="troubled", speed=1.05),
    Unit("mukashi", "でもその3ヶ月は、いまの決まりではないのだ。", anim=0.0,
         speed=1.05),
    Unit("obi0", "まずその決まりでは、最初に7日間の待ち時間があるのだ。", anim=1.6,
         speed=1.05),
    Unit("taiki", "その7日間は、待期と呼ばれる期間のこと。", anim=1.4, speed=1.05),
    Unit("taiki", "そして待期は、辞め方にかかわらず誰にでもあるのだ。", anim=0.0,
         speed=1.05),
    Unit("obi0", "その待期のあとに、もうひとつ待つ期間がつくのだ。", anim=1.6,
         speed=1.05),
    ...
    Unit("kaisha", "でも5年に3回以上あると、3ヶ月に戻るのだ。", anim=0.0,
         speed=1.05),
    Unit("kaisha", "そして実際に振り込まれるのは、手続きのぶんさらに先なのだ。",
         anim=0.0, speed=1.05),
    Unit("shime", "だから辞める時期は、この長さを見てから決めてほしいのだ。",

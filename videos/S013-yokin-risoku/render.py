...
SCENES = {
    ...
    "bukka": sc.card("それでも", "物価2%仮定なら実質目減り", "(金利0.4% − 物価2% = マイナス)", BADGE, BRAND,
                     main_size=42),
    "hayami": sc.hayami("100万円・1年の利息", [
        ("普通預金 0.40%", "4,000円"),
        ("定期1年 0.50%", "5,000円"),
        ("旧金利 0.001%", "10円"),
    ], "大手銀行・2026年8月時点(変動あり)", BADGE, BRAND, focal=0),
...
UNITS = [
    Unit("hero_count", "【4千円】。", anim=1.2, cover=True, se="pop", face="normal",
         speed=1.05, intonation=1.2, pitch=0.0),
    Unit("hero_full", "100万円を、1年預けたときの利息。", anim=0.8, speed=1.2),
    Unit("sukuna", "「少なっ」と思った?", narration="「すくなっ」と思った?", anim=1.2, face="troubled",
         speed=1.1, intonation=1.2, pause_scale=1.2),
    Unit("mukashi", "でも数年前まで、たった【10円】だったのだ。", anim=1.2, speed=1.15),
    Unit("bai400", "つまり利息は、【400倍】になったのだ。", anim=1.4, face="surprised",
         puchun=True, se="impact", se_at=0.34,
         speed=1.1, intonation=1.2, pitch=-0.05, pause_scale=1.3),
    Unit("kinri", "金利0.001%が、0.4%になったのだ。", anim=1.8, speed=1.15),
    Unit("teiki", "定期預金なら0.5%。利息5千円なのだ。", anim=1.2, speed=1.15),
    Unit("zeikin", "ただし税金2割引かれて、手取り約3千2百円。", anim=1.2, face="troubled",

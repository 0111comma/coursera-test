...
投稿用動画：FL005-nisa-dividend.mp4（1080×1920／30fps／36.67秒）
スマホ確認版：FL005-mobile.mp4
サムネイル：FL005-thumbnail.jpg
...
```text
NISAで日本株の配当20万円をもらい、旅行に使うつもりのずんだもん。
...
#ずんだもん #NISA #配当金 #お金の勉強 #shorts
```

## タグ

ずんだもん,四国めたん,NISA,新NISA,日本株,配当金,株式数比例配分方式,税金,金融リテラシー,お金の勉強,shorts

## 固定コメント案

日本株をNISAで持っている人は、配当金の受取方法を確認してみてください。「株式数比例配分方式」が確認する設定です。手続きに必要な日数は証券会社によって異なります。
...
公開日時：未設定。ユーザーが手動で投稿。
全文字幕は映像に焼き込み済み。別途FL005-subtitles.srtを添付。

...
SCENES = {
    ...
    "takaku": chart_up("株価が3倍に上がった場合", [SELL, BUY]),
...
UNITS = [
    ...
    Unit("step3", "株が80万円まで下がったら、買い戻して返すのだ。", anim=1.2, speed=1.15),
    Unit("rei", "100万円で売って80万円で買い戻す。差額の20万円がもうけなのだ。", anim=1.4, se="don", face="happy",
         speed=1.1, intonation=1.2),
    Unit("imi", "これが、下がると得をする仕組み。", anim=1.2, speed=1.15),
    Unit("toi", "では、3倍に上がってしまったら?", anim=1.4, face="troubled",
         speed=1.1, intonation=1.2, pause_scale=1.3),
    Unit("takaku", "その株を返すために、300万円で買うことになるのだ。", anim=1.2, face="troubled",
         speed=1.15),
    Unit("baisu", "100万円で売って300万円で買い戻す。損は【200万円】なのだ。", anim=1.4, face="surprised",

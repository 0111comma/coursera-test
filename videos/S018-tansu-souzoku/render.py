...
UNITS = [
    ...
    Unit("kiso", "まず多くの人は、申告そのものが要らないのだ。", anim=1.4,
         speed=1.05),
    Unit("kiso", "その線は、3000万円に人数ぶんを足す。", anim=0.0,
         speed=1.05),
    Unit("kiso", "その人数ぶんは、相続する人ひとりに600万円。", anim=0.0,
         speed=1.05),
    Unit("kiso_z", "だからふたりなら、4200万円までなのだ。",
         anim=1.6, speed=1.05),
    Unit("bareru", "でもその線を超えると、話が変わるのだ。", anim=1.4, speed=1.05),
    Unit("bareru", "そこでは税務署が、故人の口座を見る。", anim=0.0,
         speed=1.05),
    Unit("bareru", "しかも10年前まで、さかのぼれるのだ。", anim=0.0,
         face="surprised", se="impact", se_at=0.28, speed=1.05, intonation=1.2),
    Unit("bareru", "だからその出金は、使い道を聞かれるのだ。", anim=0.0,
         speed=1.05),
    Unit("zei0", "では隠していた場合、いくら増えるのか。", anim=1.6, speed=1.05),
    Unit("zei0", "たとえばその税額が、100万円だとする。", anim=0.0, speed=1.05),
    ...
    Unit("dankai", "ただし上乗せは、隠し方の悪さで変わるのだ。", anim=1.6,
         speed=1.05),
    Unit("dankai", "そして遅れた分の延滞税も、別にかかるのだ。", anim=0.0,
         speed=1.05),
    Unit("shime", "だから実家の現金は、早めに数えてほしいのだ。", anim=1.4,

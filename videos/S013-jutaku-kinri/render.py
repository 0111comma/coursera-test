...
SCENES = {
    ...
    "kinri1": sc.card("いまの変動金利は", "年1.025%", "(2026年8月・大手行の水準)",
                      ...
                      ask="あなたなら、どっちを選ぶ?"),
    "yasui": kaeshi(ia=INT_VAR, ib=INT_FIX, note="いまは変動が安い"),
    "agaru": sc.card("ただし変動は", "途中で上がる", "(そこが固定とのちがい)",
    ...
    "maitsuki": sc.card("毎月の返済は", "こうふえる", "(金利1%ぶんの差)",
                        BADGE, BRAND, main_size=58, head_fs=34),
    "gyakuten": sc.quiz("ここが知りたい所", "どこまで上がれば", "逆転する?", "", BADGE, BRAND),
    "gonen": sc.card("まず考える時点", "5年後", "(そこから金利が上がった場合)",
                     BADGE, BRAND, main_size=86, head_fs=34),
...
UNITS = [
    Unit("nazo", "3000万円の家。変動と固定で1377万円。", anim=1.0, cover=True,
         se="pop", face="normal", speed=1.05, intonation=1.25),
    Unit("shurui", "変動と固定は、住宅ローンの金利なのだ。", anim=1.2, face="happy",
         speed=1.15, intonation=1.2),
    Unit("kotei", "変動は途中で変わり、固定は変わらない。", anim=1.6, speed=1.15),
    Unit("kinri1", "その変動は、いま年1.025%。", anim=1.4, speed=1.15),
    Unit("kinri2", "一方の固定は、年3.14%。", anim=1.4, speed=1.15),
    Unit("kariru", "これで3000万円を、35年借りるとする。", anim=1.4, speed=1.15),
    Unit("goukei1", "すると変動なら、ぜんぶで3571万円。", anim=1.4, speed=1.15),
    Unit("goukei2", "一方の固定は、4948万円になる。", anim=1.6, face="surprised",
         se="impact", se_at=0.34, speed=1.1, intonation=1.2),
    Unit("sa", "その差が、さっきの1377万円。", anim=1.4, face="surprised",
         speed=1.1, intonation=1.2),
    Unit("yasui", "つまりここまでなら、変動が安い。", anim=1.4, speed=1.15),
    Unit("agaru", "でも変動は、途中で上がることがある。", anim=1.4, face="troubled",
         speed=1.15),
    Unit("toi", "その変動が1%上がると?", anim=1.4, face="troubled",
         speed=1.1, intonation=1.2, pause_scale=1.3),
    Unit("maitsuki", "すると毎月、1万4728円ふえるのだ。", anim=1.4, face="surprised",
         speed=1.15),
    ...
    Unit("narabu", "その総額が、4948万円になる。", anim=1.6, face="surprised",
         puchun=True, se="don", speed=1.1, intonation=1.2),
    Unit("narabu2", "つまり固定と、ぴったり同じなのだ。", anim=1.4, speed=1.15),

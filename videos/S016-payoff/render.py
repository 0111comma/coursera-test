...
SCENES = {
    ...
    "jigyaku": sc.card("ここだけの話", "ボクの貯金は余裕でセーフ", "(上限まで、だいぶ余白があるのだ)", BADGE, BRAND,
                       main_size=42),
    "hayami": sc.hayami("守られる貯金には、上限がある", [
        ("円の預金", "1,000万+利息"),
        ("決済用預金", "全額"),
        ("外貨預金", "対象外"),
        ("同じ銀行の口座", "合算される"),
        ("発動の実例", "2010年"),
    ], "預金保険機構・2026年8月時点(1銀行1人あたり)", BADGE, BRAND, focal=0),
...
UNITS = [
    ...
    Unit("kotae", "【1000万円と利息】までは、守られるのだ。", anim=1.4, face="surprised",
    ...
    Unit("meyose", "同じ銀行なら、口座を分けても合算なのだ。", anim=1.2, speed=1.15),
    Unit("jigyaku", "ちなみにボクの貯金は、余裕でセーフなのだ。", anim=1.2, face="happy",
         speed=1.1, intonation=1.3, pitch=0.02),
    Unit("hayami", "守られる範囲は、【早見表】なのだ。", anim=0.8, se="pop", speed=1.2),

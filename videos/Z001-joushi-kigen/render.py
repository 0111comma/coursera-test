...
SCENES = {
    ...
    "quote_k": sz.quote_card("苦しめるのは出来事じゃなく|あなたの判断だ", "『自省録』の8巻"),
...
UNITS = [
    ...
    Unit("kangaenai", "で、『変えられないことは、考えない』。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    Unit("dare", "これ、1900年前の奴隷の考え方なんだよ。知ってた?", anim=1.7, speed=1.15, intonation=1.25, pad=0.08, chara="none"),
    Unit("epi", "奴隷はエピクテトスっていう、ローマの人。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    Unit("epi2", "エピクテトスを持ってたのは、ローマ皇帝ネロの秘書。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    Unit("mochimono", "だから体も持ち物も、ぜんぶ秘書のものでしょ?", anim=1.7, speed=1.15, intonation=1.25, pad=0.08, chara="none"),
    Unit("kazoeru", "なのに、何を思うかだけは、秘書にも命令できない。", anim=1.7, speed=1.13, intonation=1.3, pad=0.12, se='don', chara="none"),
    Unit("jugyou", "秘書は、奴隷のまま哲学の授業に通わせてくれたんだって。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    Unit("sensei", "自由になったあと、哲学の先生になって、そう教えたの。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    Unit("kakanai", "でも先生なのに、本は1冊も書いてない。意外でしょ?", anim=1.7, speed=1.15, intonation=1.25, pad=0.08, chara="none"),
    Unit("deshi", "先生の授業のメモを、弟子のアリアノスって人が本にしたの。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    Unit("teiyou2", "メモから53個の短い話だけ選んだ薄い本が『提要』。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),

    # ---- なぜ残ったか・誰が評価したか
    Unit("naze", "『提要』は薄い本なのに、なんで1900年も残ったと思う?", anim=1.7, speed=1.15, intonation=1.25, pad=0.08, chara="none"),
    Unit("koutei", "まず、読んでたのがネロよりずっとあとの皇帝。", anim=1.7, speed=1.13, intonation=1.25, pad=0.1, se='don', chara="none"),
    Unit("koutei2", "皇帝の名前はマルクス・アウレリウス。知ってる?", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    Unit("jiseiroku", "皇帝は自分のノート『自省録』に、恩人の名前を書いてる。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    Unit("jiseiroku2", "恩人は、奴隷の本を貸してくれた皇帝の家庭教師。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    Unit("ekibyou", "皇帝が治めてたころは、はやり病と攻めてくる敵だらけ。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    ...
    Unit("quote_k", "皇帝の答え:「苦しめるのは出来事じゃなく、あなたの判断だ」。", anim=1.9, speed=1.13, intonation=1.25, pad=0.1, chara="none"),
    Unit("shuudouin", "皇帝のあとは修道院。奴隷の本を修行の本にしたんだって。", anim=1.7, speed=1.15, intonation=1.15, pad=0.08, chara="none"),
    Unit("namae", "修行の本って言っても、変えたのは哲学者の名前だけ。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    Unit("insatsu", "で、元の本も、印刷ができるまで1000年以上残った。", anim=1.7, speed=1.15, intonation=1.15, pad=0.08, chara="none"),
    Unit("ima", "しかも、いまの心の治療の元にもなってるの、知ってた?", anim=1.7, speed=1.15, intonation=1.25, pad=0.08, chara="none"),
    Unit("ellis", "治療に使ったのは、アルバート・エリスって心理学者。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    Unit("cbt", "認知行動療法って、考え方のクセを直す治療ね。知ってた?", anim=1.7, speed=1.15, intonation=1.25, pad=0.08, chara="none"),
    Unit("quote", "治療の元は『提要』の5番目。「不安にするのは出来事じゃない」。", anim=1.9, speed=1.13, intonation=1.25, pad=0.1, chara="none"),
    Unit("quote2", "「出来事についての、自分の考えだ」。", anim=1.7, speed=1.13, intonation=1.25, pad=0.12, se='don', chara="none"),
    Unit("atama", "つまり、出来事より、しんどいのは自分の頭のほうでしょ?", anim=1.7, speed=1.15, intonation=1.25, pad=0.08, chara="none"),
    Unit("naoseru", "で、頭の中なら直せるでしょ? だから治療になったんだって。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    Unit("abc", "治療では、出来事のときどう考えたかを紙に書かせるの。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    Unit("onaji2", "治療と同じで、あなたが書くのは明日の一言だけ。", anim=1.7, speed=1.13, intonation=1.2, pad=0.08, chara="none"),
    ...
    Unit("tana", "書けたら、あなたはもう上司のことは気にしないで帰ろ。", anim=1.7, speed=1.13, intonation=1.2, pad=0.08, chara="none"),
    Unit("iwanami", "ちなみに、岩波文庫『人生談義』の下巻に入ってるよ。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    Unit("youroku", "下巻のいちばん後ろ、『要録』って名前で入ってるよ。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),

...
UNITS = [
    ...
    Unit("hantei", "今日の言い方を直すか、明日の一言を決めるか。", anim=1.7, speed=1.17,
         intonation=1.3, pad=0.06, chara="none"),
    # **×は「直す」に落ちる**。前カットの語「今日の言い方を直す」をそのまま受けて、許可の形で×にする
    Unit("batsu", "今日の言い方は、もう直さなくていい。", anim=1.7, se="don",
         speed=1.15, intonation=1.3, pad=0.10, chara="none"),
    # 視聴者が実際に思う言い方まで具体化する
    Unit("tsukkomi", "でも、できたら苦労しない、って顔?", anim=1.7, speed=1.17,
         intonation=1.3, pad=0.06, chara="none"),
    ...
    Unit("q1", "じゃあ、今日の反省はどっちの側?", anim=1.7, speed=1.17,
         intonation=1.3, pad=0.06, chara="none"),
    # 問いの語「反省」で受け、判定を「動かせない側」の語で置く
    Unit("a1", "反省は変えられない側。", anim=1.7, speed=1.15,
    ...
    Unit("saihousou", "上司の席は、1900年前から表に無い。", anim=1.7,
         speed=1.13, intonation=1.25, pad=0.10, chara="none"),
    ...
    Unit("urakiri", "その一言、今夜は決めるだけでいい。", anim=1.7,

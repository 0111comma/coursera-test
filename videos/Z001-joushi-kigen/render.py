...
SCENES = {
    ...
    "quote5a": sz.quote_card("知らない人は他人のせい|習いたては自分のせいにする", "『提要』の5番目"),
...
UNITS = [
    ...
    Unit("jiseiroku", "皇帝は『自省録』ってノートに、若い頃の先生への感謝を書いてて。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    Unit("jiseiroku2", "その先生が、エピクテトスの本を貸してくれたんだって。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    Unit("jinchuu", "で、そのノート、戦争に行ってる最中に書いてるの。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    ...
    Unit("quote_k", "皇帝は「つらいのは出来事じゃなくて、受け取り方だ」って。", anim=1.9, speed=1.13, intonation=1.25, pad=0.1, chara="none"),
    Unit("quote_k2", "で、「その受け取り方は今すぐやめられる」って。できそう?", anim=1.7, speed=1.13, intonation=1.25, pad=0.1, chara="none"),

    # ---- 提要5(誰が評価した: 皇帝と同じ文)
    Unit("moto5", "この受け取り方の話、『提要』の5番目とそっくりなんだよ。", anim=1.7, speed=1.15, intonation=1.25, pad=0.08, chara="none"),
    Unit("quote", "『提要』5番目は「不安にするのは出来事じゃなく、考え方だ」。", anim=1.9, speed=1.13, intonation=1.25, pad=0.12, se='don', chara="none"),
    Unit("quote5a", "で、「知らない人は他人のせい、習いたては自分のせいにする」って。", anim=1.7, speed=1.13, intonation=1.2, pad=0.08, chara="none"),
    ...
    # ---- 修道院
    Unit("shuudouin", "で、皇帝のあと、修道院がこの本を修行に使ったの。", anim=1.7, speed=1.15, intonation=1.15, pad=0.08, chara="none"),
    Unit("shugyou", "修行って、自分のものじゃないものを気にしない練習なんだって。", anim=1.7, speed=1.15, intonation=1.25, pad=0.08, chara="none"),
    Unit("shugyou2", "気にしないって本だから、練習にぴったりでしょ?", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    ...
    Unit("insatsu", "で、元の本も印刷の時代まで1000年以上、写して残ったの。", anim=1.7, speed=1.15, intonation=1.15, pad=0.08, chara="none"),
    ...
    Unit("tehon", "その手本にしたのが、さっきの『提要』の5番目なの。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    ...
    Unit("onaji3", "この治療も、責めるんじゃなくて考えを直すってとこは同じなの。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    ...
    Unit("abc3", "いや、本当じゃないよね。一言でダメになるわけじゃないし。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),

...
UNITS = [
    ...
    Unit("yaku", "それ考えてて、明日なんかいいことある?", anim=1.7, speed=1.15,
    ...
    Unit("hyouka2", "上司の評価だって、自分じゃどうにもできないし。", anim=1.7,
    ...
    Unit("dorei", "実は、1900年前の奴隷なんだって。", anim=1.7,
         speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    ...
    Unit("hon", "それが今も本に残ってるんだよ。", anim=1.7,
         speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    ...
    Unit("tana", "書けたら、上司の機嫌はもうほっといて帰ろ。", anim=1.7, speed=1.13,
         intonation=1.2, pad=0.08, chara="none"),

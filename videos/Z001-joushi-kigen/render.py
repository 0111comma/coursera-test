...
SCENES = {
    ...
    "quote_k": sz.quote_card("出来事じゃなく|その判断だ", "『自省録』8巻47節"),
    "quote_k2": sz.quote_card("消すのは|権内にある", "『自省録』8巻47節"),
    "moto5": sz.book_now("02_point", "『提要』第5章", bubble="そっくり"),
    "kennai": sz.slave_sees("02_point"),
    "quote": sz.quote_card("出来事じゃなく|それへの考え", "『提要』第5章"),
...
UNITS = [
    ...
    Unit("sanko", "たとえば上司の機嫌。", anim=1.5,
         speed=1.28, intonation=1.2, pad=0.05, chara="none"),
    Unit("hyouka2", "あなたへの評価も、決めるのは上司。", anim=1.7,
    ...
    Unit("dare", "これ、1900年前のローマ帝国の元奴隷、エピクテトスの言葉。", anim=1.7, speed=1.30, intonation=1.25, pad=0.05, chara="none"),
    Unit("epi", "エピクテトスは、ストア派。聞いたことある?", anim=1.7, speed=1.30, intonation=1.25, pad=0.05, chara="none"),
    Unit("stoa", "ストア派は「ストイック」の語源。でも我慢の話じゃないの。", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),
    Unit("stoa2", "で、変えられるものは「権内にある」ってエピクテトスは言ったの。", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),
    Unit("kennai", "明日あなたが言うことは権内にある。でも上司の機嫌は権内にない。", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),
    Unit("epi2", "そのエピクテトスの主人は、皇帝ネロの秘書だったの。", anim=1.7, speed=1.30, intonation=1.25, pad=0.05, chara="none"),
    ...
    Unit("jugyou", "主人も自由になった「解放奴隷」。授業に通わせてくれたの。", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),
    Unit("sensei", "エピクテトスも自由になって、今度は哲学を教えた。", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),
    Unit("hyouban", "哲学の授業で、体も持ち物も評判も権内にないって言ったの。", anim=1.7, speed=1.30, intonation=1.25, pad=0.05, chara="none"),
    ...
    Unit("goroku", "そのメモが『語録』。自分でも読めるの。", anim=1.5, speed=1.28, intonation=1.2, pad=0.05, chara="none"),
    Unit("teiyou2", "『語録』から要点だけ選んで、53章の『提要』にまとめたの。", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),
    ...
    Unit("koutei", "まず『語録』を読んだのが、ずっとあとのローマ皇帝なんだよ。", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),
    Unit("koutei2", "読んだ皇帝が、マルクス・アウレリウス。", anim=1.5, speed=1.28, intonation=1.25, pad=0.05, chara="none"),
    Unit("koutei3", "皇帝が書きためた自分だけのノート、それが『自省録』。", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),
    Unit("koutei4", "『自省録』の最初は、自分じゃなく先生へのお礼。", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),
    ...
    Unit("quote_k", "皇帝が書いたのは「苦しめるのは出来事じゃなく、あなたの判断」。", anim=1.9, speed=1.28, intonation=1.25, pad=0.1, chara="none"),
    Unit("quote_k2", "続けて「その判断を消すのは権内にある」って書いてるの。", anim=1.7, speed=1.28, intonation=1.25, pad=0.1, chara="none"),

    # ---- 提要5(誰が評価した: 皇帝と同じ文)
    Unit("moto5", "「判断」は、あなたの受け取り方。『提要』の第5章も同じ。", anim=1.7, speed=1.28, intonation=1.2, pad=0.05, chara="none"),
    Unit("quote", "第5章は「不安にするのは出来事じゃなく、それへの考えだ」。", anim=1.9, speed=1.28, intonation=1.25, pad=0.05, chara="none"),
    ...
    # ---- 修道院
    Unit("shuudouin", "さて『提要』は、皇帝の時代より後も修道院が写し続けた。", anim=1.7, speed=1.30, intonation=1.15, pad=0.05, chara="none"),
    Unit("insatsu", "修道院が写して、印刷まで1000年以上。", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),
    Unit("shugyou", "修道院の「禁欲」は、自分の権内にないものを欲しがらない練習。", anim=1.7, speed=1.30, intonation=1.25, pad=0.05, chara="none"),
    Unit("namae", "その前に、キリスト教の人がソクラテスの名前を変えたの。", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),
    Unit("namae2", "名前を聖パウロに変えただけで、中身はそのまま残ってる。", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),
    ...
    Unit("kako2", "エリスは、子どもの頃を掘る「精神分析」じゃ治らないと考えた。", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),
    Unit("imakangae", "だから1955年、いまの考えを直す「論理療法」を始めたの。", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),
    Unit("tehon", "エリスは『提要』の第5章を、自分の論理療法の手本にしたの。", anim=1.9, se='don', speed=1.28, intonation=1.25, pad=0.10, chara="none"),
    Unit("cbt", "論理療法は、考え方のクセを直す「認知行動療法」の元の一つ。", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),
    Unit("abc", "論理療法のやり方をエリスが「ABC理論」にまとめたの。", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),
    Unit("abc0", "ABC理論では、出来事と考えと気持ちを自分で分けて書く。", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),
    Unit("abc3", "たとえばAは上司の一言、Bは「もうダメだ」、Cはいまの落ち込み。", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),
    Unit("abc2", "「もうダメだ」に証拠ある? って問い返すのが「論駁」。", anim=1.7, speed=1.30, intonation=1.25, pad=0.05, chara="none"),

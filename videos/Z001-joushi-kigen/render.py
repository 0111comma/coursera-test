...
UNITS = [
    ...
    Unit("yaku", "その考え、明日の役に立つ?", anim=1.7, speed=1.15,
         intonation=1.25, pad=0.08, chara="none"),
    Unit("tatanai", "いや、立たない。", anim=1.5, speed=1.13,

...
SCENES = {
    ...
    "sensei": sz.ancient_person("05_happy", "教えの1番目", "自由になったあと"),
    ...
    "quote_k": sz.quote_card("苦しめてるのは出来事じゃなく|どう思うかだ", "『自省録』の8巻"),
    "quote_k2": sz.quote_card("その判断は|いま消せる", "『自省録』の8巻"),
    "shuudouin": sz.copyists("01_base"),
    "shugyou": sz.book_now("01_base", "修行の本", bubble="欲を抑える練習"),
    ...
    "tehon": sz.book_now("02_point", "提要", bubble="手本"),
    "cbt": sz.counselor("01_base", "認知行動療法"),
    "cbt2": sz.counselor("05_happy", "考え方のクセを直す"),
    "moto5": sz.book_now("02_point", "提要の5番目", bubble="元はここ"),
    "quote": sz.quote_card("不安にするのは出来事じゃなく|考え方だ", "『提要』の5番目"),
    "tsuzuki": sz.book_now("01_base", "5番目の続き", bubble="まだある"),
    ...
    "naoseru": sz.counselor("05_happy", "考えを直す"),
    "abc": sz.memo_tag("02_point", "考え→本当か調べる"),
...
UNITS = [
    ...
    # ---- 誰が言ったか。考え方の一般文 → 行き先(治療) → 奴隷 → 名前 → 流派
    Unit("kangaenai", "だから、変えられないことは考えない。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    Unit("dare", "これ、1900年前の元奴隷の考え方で、いま治療の元なの。", anim=1.7, speed=1.15, intonation=1.25, pad=0.08, chara="none"),
    Unit("epi", "元奴隷はエピクテトスって人。ストア派って流派、知ってる?", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    Unit("stoa", "ストア派が、『ストイック』って言葉の元なんだよ。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    Unit("epi2", "その人の持ち主、誰だと思う? 皇帝ネロの秘書。", anim=1.7, speed=1.15, intonation=1.25, pad=0.08, chara="none"),
    Unit("mochimono", "だから体も持ち物も、ぜんぶ持ち主のもの。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    Unit("kazoeru", "でも、何を考えるかまでは、持ち主にも決められないじゃん?", anim=1.7, speed=1.13, intonation=1.3, pad=0.12, se='don', chara="none"),
    Unit("jugyou", "で、持ち主が奴隷のまま哲学の授業に行かせてくれたの。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    Unit("sensei", "自由になって哲学の先生になって、教えの1番目がこれ。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    Unit("hyouban", "1番目は、体も持ち物も周りの評判も自分のものじゃない。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    ...
    Unit("teiyou2", "そのメモをまとめた薄い本が『提要』。短い教えが53個。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    ...
    Unit("koutei", "まず、写して読んだのがネロよりずっと後の皇帝なの。", anim=1.7, speed=1.13, intonation=1.25, pad=0.1, se='don', chara="none"),
    ...
    Unit("ekibyou2", "皇帝でも止められなかった。上司の機嫌と同じでしょ?", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    Unit("onaji", "で、皇帝も『自省録』に、奴隷とそっくりなことを書いてて。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    Unit("quote_k", "皇帝は「苦しめてるのは出来事じゃなく、どう思うかだ」。", anim=1.9, speed=1.13, intonation=1.25, pad=0.1, chara="none"),
    Unit("quote_k2", "で、「その判断は、いま消せる」って。", anim=1.7, speed=1.13, intonation=1.25, pad=0.1, chara="none"),
    Unit("shuudouin", "そのあと修道院が、奴隷の本を修行に使ったの、知ってた?", anim=1.7, speed=1.15, intonation=1.15, pad=0.08, chara="none"),
    Unit("shugyou", "修行って欲を抑える練習ね。奴隷の本がぴったりでしょ?", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    Unit("namae", "奴隷の本で変えたのは、ソクラテスを聖人にしたくらい。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    ...
    Unit("imakangae", "だからエリスは、いまの考えを直す治療にしたの。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    Unit("tehon", "その手本に、奴隷の本を置いたの。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    Unit("cbt", "で、エリスの治療が広がったのが、いまの認知行動療法。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    Unit("cbt2", "考え方のクセを直す治療。あなたも聞いたことない?", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    Unit("moto5", "で、皇帝のあの文の元は『提要』の5番目。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    Unit("quote", "『提要』5番目は「不安にするのは出来事じゃなく、考え方だ」。", anim=1.9, speed=1.13, intonation=1.25, pad=0.12, se='don', chara="none"),
    Unit("tsuzuki", "『提要』の5番目には続きがあって、", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    Unit("quote5a", "で、「習ってない人は人を、初心者なら自分を責める」。", anim=1.7, speed=1.13, intonation=1.2, pad=0.08, chara="none"),
    Unit("quote5b", "「初心者を終えた人は、どっちも責めない」。", anim=1.7, speed=1.13, intonation=1.25, pad=0.1, chara="none"),
    Unit("semenai", "だから上司も自分も責めなくていい。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    Unit("naoseru", "で、責める代わりに考えを直す。それが治療になったの。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    Unit("abc", "治療だと、どう考えたか紙に書いて、本当かを調べるの。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),

    # ---- 動作 → 締め
    Unit("memo", "で、あなたも今夜、明日なに言うかをメモに1行書いてみ?", anim=1.7, speed=1.15, intonation=1.25, pad=0.06, chara="none"),
    ...
    Unit("comment", "書けたら、なに書いたかコメントで教えて。", anim=1.7, speed=1.13, intonation=1.2, pad=0.06, chara="none"),
    Unit("tana", "で、あなたはもう上司のことは忘れて帰ろ。", anim=1.7, speed=1.13, intonation=1.2, pad=0.08, chara="none"),
]

...
SCENES = {
    ...
    "quote_k": sz.quote_card("苦しいのは出来事じゃなく|判断のほうだ", "『自省録』の8巻"),
    "quote_k2": sz.quote_card("その判断は|今すぐやめられる", "『自省録』の8巻"),
    "moto5": sz.book_now("02_point", "提要の5番目", bubble="そっくり"),
    "quote": sz.quote_card("不安にするのは出来事じゃなく|考え方だ", "『提要』の5番目"),
    "quote5a": sz.quote_card("知らない人は他人を責めて|習いたてなら自分を責める", "『提要』の5番目"),
    "quote5b": sz.quote_card("慣れた人は|どっちも責めない", "『提要』の5番目"),
    ...
    "abc3": sz.boss_sheet("02_point", "評価"),
...
UNITS = [
    ...
    Unit("stoa2", "中身は、変えられないことは欲しがらない、って教えなの。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    Unit("epi2", "この人のご主人、誰だと思う? ローマ皇帝ネロの秘書だよ。", anim=1.7, speed=1.15, intonation=1.25, pad=0.08, chara="none"),
    ...
    Unit("hyouban", "先生の教えは、体も持ち物も評判も自分のものじゃない。", anim=1.7, speed=1.15, intonation=1.25, pad=0.08, chara="none"),
    ...
    Unit("naze", "なのに、なんで1900年も残ったと思う? 読んだ人がすごいの。", anim=1.7, speed=1.15, intonation=1.25, pad=0.08, chara="none"),
    ...
    Unit("jiseiroku2", "その恩人が若いころの先生で、奴隷の本を貸してくれたんだって。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    ...
    # ---- 提要5(誰が評価した: 皇帝と同じ文)
    Unit("moto5", "この判断の話、『提要』の5番目とそっくりなんだよ。", anim=1.7, speed=1.15, intonation=1.25, pad=0.08, chara="none"),
    Unit("quote", "『提要』5番目は「不安にするのは出来事じゃなく、考え方だ」。", anim=1.9, speed=1.13, intonation=1.25, pad=0.12, se='don', chara="none"),
    Unit("quote5a", "で、「知らない人は他人を、習いたてなら自分を責める」って。", anim=1.7, speed=1.13, intonation=1.2, pad=0.08, chara="none"),
    Unit("quote5b", "そして「慣れた人はどっちも責めない」って。", anim=1.7, speed=1.13, intonation=1.25, pad=0.1, chara="none"),
    Unit("semenai", "だから、いま自分を責めてるあなたは初心者。明日から、どっちも責めない側に行こ。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),

    # ---- 修道院
    Unit("shuudouin", "で、皇帝のあと、修道院が奴隷の本を修行に使ったの。", anim=1.7, speed=1.15, intonation=1.15, pad=0.08, chara="none"),
    Unit("shugyou", "修行って、自分のじゃない物は気にしない練習なの。", anim=1.7, speed=1.15, intonation=1.25, pad=0.08, chara="none"),
    Unit("shugyou2", "練習には、気にしない、って本だからぴったりでしょ?", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    Unit("namae", "で、修道院が変えたのは、ソクラテスの名前くらいなの。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    ...
    Unit("kako", "エリスも前は、子どものころの過去を何年も掘る治療をしてたの。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    ...
    Unit("onaji3", "この治療も、責めるより考えを直す、ってとこは同じなの。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    ...
    Unit("abc3", "いや、本当じゃないよね。ダメかどうかは上司が決めるし。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    ...
    Unit("comment", "で、書けたら、あなたがなに書いたかコメントで教えて。", anim=1.7, speed=1.13, intonation=1.2, pad=0.06, chara="none"),

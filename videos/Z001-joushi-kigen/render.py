...
UNITS = [
    ...
    Unit("hyou", "その顔に、変えられることと変えられないことを分けた表を見せる。", anim=1.7,
    ...
    Unit("a1", "反省しても、今日の言い方はもう変わらない。", anim=1.7, speed=1.15,
    ...
    Unit("saihousou", "1900年前の表に、上司の機嫌は無い。他人が決める側だから。", anim=1.7,
         speed=1.13, intonation=1.25, pad=0.10, chara="none"),

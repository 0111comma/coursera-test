...
UNITS = [
    ...
    Unit("onaji", "だから皇帝も、いちばん下だった奴隷とそっくりなこと書いてて。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    Unit("quote_k", "皇帝は「つらいのは出来事じゃなく受け取り方」って。", anim=1.9, speed=1.13, intonation=1.25, pad=0.1, chara="none"),
    Unit("quote_k2", "で、「その受け取り方は今すぐやめられる」って。できそう?", anim=1.7, speed=1.13, intonation=1.25, pad=0.1, chara="none"),

    # ---- 提要5(誰が評価した: 皇帝と同じ文)
    Unit("quote", "そして『提要』5番目も「不安の元は考え方だ」って。", anim=1.9, speed=1.13, intonation=1.25, pad=0.08, chara="none"),
    ...
    Unit("namae2", "名前をキリスト教の聖人パウロに替えて、中身はほぼそのまま。", anim=1.7, speed=1.15, intonation=1.2, pad=0.08, chara="none"),
    Unit("insatsu", "で、元の本のほうも、印刷までの1000年以上を手で写したの。", anim=1.7, speed=1.15, intonation=1.15, pad=0.08, chara="none"),

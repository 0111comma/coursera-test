...
UNITS = [
    ...
    Unit("stoa2", "中身は「変えられないものは欲しがるな」って教え。", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),
    ...
    Unit("insatsu", "で、元の本も、印刷までの1000年以上を手で写したの。", anim=1.7, speed=1.30, intonation=1.15, pad=0.05, chara="none"),

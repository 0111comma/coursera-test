...
UNITS = [
    ...
    Unit("dare", "これ、1900年前のローマの元奴隷が言ってたことなんだよ。", anim=1.7, speed=1.30, intonation=1.25, pad=0.05, chara="none"),
    ...
    Unit("stoa2", "中身は、変えられないものは欲しがるな、って教えなの。", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),
    Unit("epi2", "で、エピクテトスのご主人、誰だと思う? 皇帝ネロの秘書。", anim=1.7, speed=1.30, intonation=1.25, pad=0.05, chara="none"),
    Unit("mochimono", "奴隷だから、体も持ち物も、ぜんぶご主人のもの。", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),
    Unit("kazoeru", "でも、何を考えるかまでは、ご主人にも決められないじゃん?", anim=1.7, speed=1.28, intonation=1.3, pad=0.12, se='don', chara="none"),
    Unit("jugyou", "で、ご主人も元奴隷で、哲学の授業に行かせてくれたんだって。", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),
    Unit("sensei", "自由になって哲学の先生になった。教えたのは、これ。", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),
    Unit("hyouban", "先生の教えは、体も持ち物も評判も自分のものじゃない、って。", anim=1.7, speed=1.30, intonation=1.25, pad=0.05, chara="none"),
    Unit("kakanai", "でも先生なのに、本は1冊も書いてない。意外でしょ?", anim=1.7, speed=1.30, intonation=1.25, pad=0.05, chara="none"),
    Unit("deshi", "で、弟子のアリアノスって人が授業のメモを本にしたの。", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),
    Unit("teiyou2", "メモが『提要』って薄い本で、教えが53個。", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),

    # ---- なぜ残ったか(皇帝)
    Unit("utsusu", "で、昔の本って、誰かが手で写さないと消えるでしょ?", anim=1.7, speed=1.30, intonation=1.25, pad=0.05, chara="none"),
    Unit("naze", "なのに、なんで1900年も残ったと思う?", anim=1.7, speed=1.30, intonation=1.25, pad=0.05, chara="none"),
    Unit("koutei", "で、ネロよりずっと後のローマ皇帝も読んでたんだよ。", anim=1.7, speed=1.28, intonation=1.25, pad=0.1, se='don', chara="none"),
    ...
    Unit("jiseiroku", "そのノートに、若い頃の先生にありがとう、って書いてるの。", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),
    Unit("jiseiroku2", "で、先生はエピクテトスの本を貸してくれた人なんだって。", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),
    Unit("jinchuu", "しかもそのノート、戦争に行ってる最中に書いてるの。", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),
    Unit("ekibyou2", "戦争も流行り病も止められない。上司の機嫌と同じでしょ?", anim=1.7, speed=1.30, intonation=1.25, pad=0.05, chara="none"),
    Unit("onaji", "だから皇帝も、いちばん下だった奴隷とそっくりなこと書いてて。", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),
    Unit("quote_k", "皇帝は「つらいのは出来事じゃなく受け取り方」って。", anim=1.9, speed=1.28, intonation=1.25, pad=0.1, chara="none"),
    Unit("quote_k2", "で、「その受け取り方は今すぐやめられる」って。できそう?", anim=1.7, speed=1.28, intonation=1.25, pad=0.1, chara="none"),

    # ---- 提要5(誰が評価した: 皇帝と同じ文)
    Unit("quote", "そして『提要』5番目も「不安の元は考え方だ」って。", anim=1.9, speed=1.28, intonation=1.25, pad=0.05, chara="none"),
    Unit("quote5a", "で、「知らない人は人のせい、習いたては自分のせい」って。", anim=1.7, speed=1.28, intonation=1.2, pad=0.05, chara="none"),
    Unit("quote5b", "で、「ちゃんと習った人はどっちも責めない」って。", anim=1.7, speed=1.28, intonation=1.25, pad=0.12, se='don', chara="none"),
    Unit("semenai", "だから、いま自分を責めてるあなたは初心者。", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),
    Unit("semenai2", "で、明日から、どっちも責めない側に行こ。", anim=1.7, speed=1.30, intonation=1.25, pad=0.10, chara="none"),

    # ---- 修道院
    Unit("shuudouin", "で、写したのは修道院。", anim=1.7, speed=1.30, intonation=1.15, pad=0.05, chara="none"),
    Unit("shuudouin2", "修道院は皇帝のあと、この本を修行に使って写し続けたの。", anim=1.7, speed=1.30, intonation=1.15, pad=0.05, chara="none"),
    Unit("shugyou", "修行って、自分のじゃないものを欲しがらない練習なんだって。", anim=1.7, speed=1.30, intonation=1.25, pad=0.05, chara="none"),
    Unit("namae", "で、変えたのはソクラテスって人の名前くらい。意外でしょ?", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),
    Unit("namae2", "名前をキリスト教の聖人パウロに替えて、中身はほぼそのまま。", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),
    Unit("insatsu", "で、元の本のほうも、印刷までの1000年以上を手で写したの。", anim=1.7, speed=1.30, intonation=1.15, pad=0.05, chara="none"),
    ...
    Unit("imakangae", "でも良くならなくて、1955年、いまの考えを直す治療に変えたの。", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),
    Unit("tehon", "治療の手本に『提要』5番目を置いた、ってエリスが書いてる。", anim=1.9, se='don', speed=1.28, intonation=1.25, pad=0.10, chara="none"),
    Unit("cbt", "認知行動療法って聞くでしょ? 元の一つがエリスの治療なの。", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),
    Unit("abc", "治療だと「上司の一言でもうダメ」って考えを紙に書くの。", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),
    Unit("abc2", "で、それ本当? って確かめるの。", anim=1.7, speed=1.30, intonation=1.25, pad=0.05, chara="none"),
    Unit("abc3", "いや、本当じゃない。一言でダメって証拠、無いでしょ?", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),

    # ---- 動作 → 締め
    Unit("memo", "だからあなたも、明日なに言うかをメモに1行書いてみ?", anim=1.7, speed=1.30, intonation=1.25, pad=0.06, chara="none"),
    Unit("rei", "たとえば上司に『昨日の件、もう一回話せますか』だけでいいよ。", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),
    Unit("comment", "で、書けたら、なに書いたかコメントで教えて。", anim=1.7, speed=1.28, intonation=1.2, pad=0.06, chara="none"),
    Unit("iwanami", "ちなみに『提要』は、岩波文庫『人生談義』の下巻にあるよ。", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),
    Unit("youroku", "下巻の後ろのほうに『要録』って名前で入ってるよ。", anim=1.7, speed=1.30, intonation=1.2, pad=0.05, chara="none"),
    Unit("tana", "で、あなたは今日のことは忘れて、明日の一言だけ持って帰ろ。", anim=1.7, speed=1.28, intonation=1.2, pad=0.05, chara="none"),
]

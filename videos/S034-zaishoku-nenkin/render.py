...
SCENES = {
    ...
    "hyo_now": sf.table(_HYO_HEAD, _HYO, highlight=0, title="線が動きます",
                        total_mode="dim"),
    "hyo_new": sf.table(_HYO_HEAD, _HYO, highlight=1, from_row=0,
                        title="線が動きます"),
    "itsu": sf.hero("2026年4月", "線が動く時期", name=None,
                    role="neutral", count=False, size="reference"),
    "sabun": sf.hero("14万円", "65万円との差", name=None, role="gain",
                     size="reference"),
...
UNITS = [
    ...
    Unit("modoseru", "抑えた時間、来年から戻せるかも。", anim=1.0, speed=1.05,
         chara="none"),
    ...
    Unit("toi_ikura", "51万円を超えたら、いくら止まる?", anim=1.0, speed=1.0,
         intonation=1.25, chara="none"),
    Unit("kotae", "答えは、超えた分の半分。", anim=1.0, speed=1.05, chara="none"),
    Unit("hyo_now", "その51万円の線が、動きます。", anim=1.0, speed=1.0,
         intonation=1.2, chara="none"),
    Unit("itsu", "2026年4月、あなたの51万円が動く。", anim=1.0, speed=1.05,
         chara="none"),
    Unit("hyo_new", "そして、【65万円】へ。", anim=1.0, se="don",
         speed=1.0, intonation=1.25, chara="none"),
    Unit("sa", "65万円との差、14万円。", anim=1.2, speed=1.05,
         chara="none"),
        Unit("haba", "14万円で、何が変わる?", anim=1.0, speed=1.0,
         intonation=1.25, pad=0.35, chara="none"),

    Unit("rei", "たとえば年金が月10万円の人。", anim=1.0, speed=1.05,
         chara="none"),
    Unit("rei_q", "年金10万円と給料45万円の合計。", anim=1.0, speed=1.05,
         chara="none"),
    ...
    Unit("tashizan", "足すのは年金と給料の2つ。", anim=1.0, speed=1.05,
         chara="none"),

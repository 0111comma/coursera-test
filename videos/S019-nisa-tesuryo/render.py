...
UNITS = [
    ...
    Unit("tesu", "その名前が、信託報酬なのだ。", anim=0.0, speed=1.05),
    Unit("tesu", "でも買うときの手数料は、証券会社に払う。", anim=0.0, speed=1.05),
    Unit("tesu", "そして信託報酬は、運用する会社に払う。", anim=0.0, speed=1.05),
    Unit("tesu", "つまり株を選んで入れかえる、手間ぶんなのだ。", anim=0.0, speed=1.05),
    Unit("tesu", "しかも持っているあいだ、毎日かかる。", anim=0.0, speed=1.05),

...
SCENES = {
    ...
    "hayami": sc.hayami("「壁」の早見表(2026年)", [
        ("所得税", "178万円"),
        ("住民税", "110万円"),
        ("社保(106万)", "10月に廃止"),
        ("社保(130万)", "変更なし"),
    ], "所得税の178万は時限特例込み", BADGE, BRAND, focal=0),
...
UNITS = [
    ...
    Unit("jidai", "実は2年で、2回も動いたのだ。", anim=1.8, speed=1.15),
    ...
    Unit("haishi", "その106万の壁も、今年10月に【廃止】。", anim=1.2, se="don", speed=1.15),

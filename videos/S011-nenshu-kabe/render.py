...
SCENES = {
    ...
    "shaho": sc.card("もう1つ注意", "社会保険の壁は別", "(健康保険と年金の話。税金とは別の線引き)", BADGE, BRAND, main_size=50,
                     ask="あなたに関係あるのは、どの壁?"),
    "haishi": sc.card("さらに今年", "106万の壁は10月に廃止", "(これからは「週20時間以上働くか」で決まる)", BADGE, BRAND, main_size=44),
...
UNITS = [
    ...
    Unit("hero_full", "給料で働く人に、所得税がかかり始める年収。", anim=0.8, speed=1.2),
    ...
    Unit("shaho", "健康保険と年金の壁は、また【別】なのだ。", anim=1.2, face="troubled",

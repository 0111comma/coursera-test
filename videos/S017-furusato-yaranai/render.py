...
UNITS = [
    ...
    Unit("jogen", "たとえば年収500万円の独身で、上限を見る。", anim=1.4,
         speed=1.05),
    Unit("jogen", "ふるさと納税に使える上限は、6万円。", anim=0.0,
    ...
    Unit("matome", "もらえない額は、10年で16万円。", anim=0.0,
         speed=1.05, intonation=1.2),
    Unit("matome", "ただし払う税金は、減っていないのだ。", anim=0.0, speed=1.05),
    Unit("matome", "税金は、払う先が変わるだけなのだ。", anim=0.0, speed=1.05),
    Unit("matome", "だから返礼品のぶんだけ、得になるのだ。", anim=0.0, speed=1.05),
    Unit("shime", "なお上限は、年収と家族で変わるのだ。", anim=1.4, speed=1.05),

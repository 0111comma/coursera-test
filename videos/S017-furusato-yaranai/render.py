...
UNITS = [
    ...
    Unit("jogen", "たとえば年収500万円の独身とする。", anim=1.4,
         speed=1.05),
    Unit("jogen", "その上限は、6万円と決まっている。", anim=0.0,
    ...
    Unit("sashi", "払った2千円を引くと、1万6千円ぶんが残る。", anim=1.6,
    ...
    Unit("matome", "だから返礼品のぶんが、まるごと得になる。", anim=0.0, speed=1.05),

...
UNITS = [
    ...
    U("seneca", "役人あてに書いたのがセネカ。ローマの政治家で哲学者ね。"),
    ...
    U("migiude", "セネカは、のちに暴君と呼ばれる皇帝ネロを育てた家庭教師。", **_S),
    U("migiude2", "その皇帝の右腕だから、あなたの上司どころじゃないの。"),
    ...
    # ---- 幕5 誰が評価した(3)。**予定を実際に消した実例**
    U("yonda", "読んだ1人が、『エセー』を書いた16世紀の作家モンテーニュ。"),
    ...
    U("owari", "返事は一言。今週の予定の1件は、人に分けずにすむの。"),
]

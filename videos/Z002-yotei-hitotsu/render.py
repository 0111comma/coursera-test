...
SCENES = {
    ...
    "yameta": sz.calendar_one("05_happy", "職", "×", bubble="裁判所を辞めた"),
...
UNITS = [
    ...
    U("yonda", "セネカの一文で、実際に仕事をやめた人がいるの。誰だと思う?"),
    U("yameta", "仕事をやめたのはモンテーニュ。フランスの裁判所の役人ね。"),
    U("chuui", "この人は仕事ごとやめたけど、あなたは1件でいい。", **_S),
    U("mada", "会議を1件消しても、予定はまた入るよ。"),

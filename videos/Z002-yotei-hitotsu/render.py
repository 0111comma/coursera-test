...
UNITS = [
    ...
    U("nokotta", "てか、西暦49年の一言がなんで今のあなたに届いてるの?"),
    U("shahon", "だって昔は印刷が無いの。手で写した写本しか残らない。"),
    U("miuchi", "写本を作る修道院で、セネカだけ特別あつかいだったの。"),
    U("todoita", "セネカが聖人パウロと文通してた、って偽の手紙のおかげ。"),

    # ---- 幕5 誰が評価した(3)。**予定を実際に消した実例**
    U("yonda", "だからあなたにも届いて、フランスの役人モンテーニュも読んだ。"),
    U("yameta", "モンテーニュは37歳で、裁判所の職を手放した人ね。"),

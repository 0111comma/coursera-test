...
SCENES = {
    ...
    "shinsei": sc.card("いちばん大事", "申請しないともらえない", "(住んでいる市区町村へ。生まれて15日以内)", BADGE, BRAND,
                       main_size=44),
    "gacha": sc.card("ここだけの話", "この誕生月ガチャ、ここにも", "(4月生まれ、ちょっとお得なのだ)", BADGE, BRAND,
                     main_size=42),
...
UNITS = [
    Unit("hero_count", "【234万円】。子ども1人で親がもらう総額。", anim=1.2, cover=True,
         se="pop", face="normal", speed=1.05, intonation=1.2, pitch=0.0),
    Unit("timeline", "その内訳は3歳まで月1.5万、あと月1万円。",
         narration="その内訳は、3歳まで毎月1万5千円、あとは毎月1万円。", anim=1.8, speed=1.15),
    Unit("shotoku", "しかも今は、所得制限も【なし】なのだ。", anim=1.2, se="don", speed=1.15),
    Unit("tanjobi", "ただしこの総額、誕生月で変わるのだ。", anim=1.2, face="troubled",
         speed=1.1, intonation=1.2),
    Unit("tanjobi2", "その差、4月生まれなら245万円なのだ。", anim=1.2, speed=1.1,
         intonation=1.15),
    ...
    Unit("shinsei", "ただしどれも、【申請】しないともらえない。", anim=1.2, face="troubled",
         speed=1.1, intonation=1.15, pitch=-0.04),
    Unit("gacha", "この誕生月ガチャ、こんな所にもあるのだ。", anim=1.2, face="troubled",

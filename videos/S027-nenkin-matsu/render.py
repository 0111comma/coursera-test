...
UNITS = [
    ...
    Unit("shikumi", "まず増える割合から、確かめる。", anim=1.4, speed=1.05),
    Unit("shikumi", "割合はひと月遅らせるごとに、0.7%。", anim=0.0, speed=1.05),

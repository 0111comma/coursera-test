...
SCENES = {
    ...
    "hero_full": sc.hero("178万円", "給料で働く人に所得税がかかり始める年収", BADGE, BRAND, size=112, sub_fs=27),
    "tsusetsu": sc.card("多くの人はこう答える", "「103万円まで」", "…それ、2年前の常識なのだ", BADGE, BRAND,
                        main_color=MUTED_BAR, main_size=54),
    "jidai": scene_jidai,
    "kaisei": sc.reveal("178万円", "2026年分はここまで所得税ゼロ", "差し引ける分 104万+74万=178万", BADGE, BRAND, size=104),
    "tokurei": sc.card("ただし注意", "2年間の特例込み", "(2026・2027年分。その後は縮小予定)", BADGE, BRAND, main_size=50),
    "shaho": sc.card("もう1つ注意", "社会保険の壁は別", "(健康保険と年金の話。税金とは別の線引き)", BADGE, BRAND, main_size=50,
                     ask="あなたに関係あるのは、どの壁?"),
    "haishi": sc.card("その健康保険の壁のうち", "106万の壁は今年10月に廃止", "(これからは「週20時間以上働くか」で決まる)",
                      BADGE, BRAND, main_size=40, head_fs=32),
    "oboe": sc.card("ここだけの話", "この壁、動きすぎ", "(ボクは覚え直すたびに調べてるのだ)", BADGE, BRAND, main_size=54),
    "chips": sc.chips("この壁、知ってた?", ["知ってた", "103万だと思ってた", "自分に関係ある", "家族に教える"], BADGE, BRAND),
    "loop_back": sc.hero("178万円", "給料で働く人に所得税がかかり始める年収", BADGE, BRAND, size=112, sub_fs=27),
}

# 全ビートを But/Therefore で繋ぐ(D10・ループ㊶)。check_flow.py で断絶0件を確認すること。
UNITS = [
    Unit("hero_count", "【178万円】。所得税がかかり始める年収。", anim=1.2, cover=True,
         se="pop", face="surprised", speed=1.05, intonation=1.2, pitch=0.0),
    Unit("tsusetsu", "でも多くの人は「103万円」だと思ってる。", anim=1.4, face="troubled",
         speed=1.1, intonation=1.2),
    Unit("jidai", "実はこの壁、2年で2回も動いたのだ。", anim=1.8, speed=1.15),
    Unit("kaisei", "だから2026年分は、【178万円】まで税金ゼロ。", anim=1.4, face="surprised",
    ...
    Unit("shaho", "しかも健康保険と年金の壁は、また別なのだ。", anim=1.2, face="troubled",
         speed=1.1, intonation=1.15, pitch=-0.04),
    Unit("haishi", "その健康保険の壁は、今年10月に【廃止】。", anim=1.2, se="don", speed=1.15),
    Unit("oboe", "その壁、動きすぎなのだ。調べ直しなのだ。", anim=1.2, face="troubled",

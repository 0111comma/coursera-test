...
UNITS = [
    Unit("hero_count", "【11万5794円】。10万円の買い物の値段。", anim=1.2, cover=True,
         se="pop", face="surprised", speed=1.05, intonation=1.2, pitch=0.0),
    Unit("joken", "この10万円をリボ払い、月5千円ずつの場合。", anim=1.2, speed=1.15),
    Unit("quiz", "では、払い終わるまで何ヶ月かかる?", anim=1.4, face="troubled",
         speed=1.15, intonation=1.2, pause_scale=1.3),
    Unit("kotae", "答えは【2年】。手数料は約1万6千円なのだ。", anim=1.4, face="surprised",
         puchun=True, se="impact", se_at=0.34,
         speed=1.1, intonation=1.2, pitch=-0.05, pause_scale=1.3),
    Unit("zandaka", "その2年のうち、1年たってもまだ半分残る。", anim=1.6, face="troubled",
         speed=1.1, intonation=1.15, pitch=-0.04),
    Unit("shikumi", "この手数料、残った額に毎月かかるのだ。", anim=1.2, speed=1.15),
    Unit("ikkatsu", "ちなみに一括払いなら、手数料は【0円】。", anim=1.2, speed=1.15),
    Unit("niju", "その手数料、20万円だと約7万9千円なのだ。", anim=1.2, se="don", speed=1.1,
         face="surprised", intonation=1.15),
    Unit("akiru", "その2年後には、買った物に飽きてそうなのだ。", anim=1.2, face="troubled",

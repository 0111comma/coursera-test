...
SCENES = {
    ...
    "hero_full": sc.hero("約694万円", "始める年齢が10年ちがうと生まれる差", BADGE, BRAND,
                         size=104, sub_fs=28),
    "joken": sc.card("この差が出る条件", "月1万円を65歳まで", "(増え方は年5%と仮定した場合)", BADGE, BRAND,
                     main_size=52),
    ...
    "kasetsu": sc.card("大事な注意", "年5%は仮定", "(保証はなく、元本割れの年もある)", BADGE, BRAND,
                       main_size=56),
    "jigyaku": sc.card("ここだけの話", "その10年前のボクに教えたい", "(過去には戻れないのだ)", BADGE, BRAND,
                       main_size=40),
...
UNITS = [
    Unit("hero_count", "【694万円】。始めるのが10年おそい差。", anim=1.2, cover=True,
         se="pop", face="surprised", speed=1.05, intonation=1.2, pitch=0.0),
    Unit("joken", "この差が出る条件は、月1万円を65歳まで。", anim=1.2, speed=1.15),
    Unit("b25", "その月1万円、25歳からなら約【1526万円】。", anim=1.2, speed=1.1, intonation=1.15),
    Unit("b35", "でも35歳からだと、約【832万円】なのだ。", anim=1.2, face="troubled",
         speed=1.1, intonation=1.15, pitch=-0.04),
    Unit("gyaku", "なのに自分で多く払った額は、【120万】だけ。", anim=1.4, face="surprised",
         puchun=True, se="impact", se_at=0.34,
         speed=1.1, intonation=1.2, pitch=-0.05, pause_scale=1.3),
    Unit("curve", "この120万が、こう差になるのだ。", anim=1.8, speed=1.2),
    Unit("riyu", "この差は、早い10年ほど長く増えるから。", anim=1.2, speed=1.15),
    Unit("kasetsu", "ただし年5%は【仮定】。保証はないのだ。",
         narration="ただし年率5%は仮定。保証はないのだ。", anim=1.2, face="troubled",
         speed=1.1, intonation=1.15),
    Unit("jigyaku", "その10年前のボクに、教えたいのだ。", anim=1.2, face="troubled",

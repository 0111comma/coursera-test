...
_TE = ["損益通算は1年", "確定申告が要る", "売却は税に無関係", "枠は翌年・簿価"]
...
SCENES = {
    ...
    "tsugi": sl.card("1分で見たいとき", "ショート S017", "※ 損益通算の図だけを出しています",
                     BADGE, BRAND, main_size=88, head_fs=32),
...
UNITS = [
    ...
    Unit("te3", "だから売る時期を、税金で決めなくていいのだ。", anim=0.0,
         speed=1.05, chara="none"),
    Unit("te4", "そして4つめ。売っても枠が戻るのは、翌年なのだ。", anim=1.4,
         speed=1.05, chara="none"),
    Unit("waku2", "たとえば100万円で買ったものが、値下がりしたとする。", anim=1.4,
         speed=1.05, chara="none"),
    Unit("waku2", "そして80万円で売っても、翌年に戻る枠は100万円ぶん。", anim=0.0,
         speed=1.05, chara="none"),
    ...
    Unit("shime", "だからNISAで売っても、税金の話は動かないのだ。", anim=1.4,
         face="smug", speed=1.05),
    Unit("tsugi", "そしてこの話の1分版が、ショートのS017にあるのだ。", anim=1.4,
         face="happy", speed=1.1),
    Unit("tsugi", "その1分版なら、損益通算の図だけを見られるのだ。", anim=0.0,
         speed=1.1),

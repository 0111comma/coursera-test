...
UNITS = [
    ...
    Unit("sousai0", "では同じ年に、別の株で20万円もうけていたとするのだ。", anim=1.4,
    ...
    Unit("sousai2", "損した株が、税金を40630円減らしてくれたのだ。", anim=0.0,
         face="happy", speed=1.05, intonation=1.25, chara="none"),
    ...
    Unit("uchiwake", "うち所得税と住民税で、20%を占めるの。", anim=0.0,
         speaker=2, speed=1.05, chara="none"),
    Unit("uchiwake", "まず所得税が、15%。", anim=0.0, speaker=2, speed=1.1, chara="none"),
    Unit("uchiwake", "そして住民税が、5%なのだ。", anim=0.0, speed=1.1, chara="none"),
    Unit("uchiwake", "さらに残りの0.315%が、復興特別所得税なのだ。", anim=0.0,
    ...
    Unit("sashihiki", "その差し引きの後に残るのは、0円なのだ。", anim=0.0,
         speed=1.05, chara="none"),
    Unit("sashihiki", "そうよ。だから税金も、0円になるの。", anim=0.0,
         speaker=2, se="pop", face="happy", speed=1.05, chara="none"),
    Unit("sashihiki", "課税口座では、損が税金を消す材料になるのよ。", anim=0.0,
         speaker=2, speed=1.05, chara="none"),
    ...
    Unit("nen3", "だから2年目の利益40万円に、81260円かかるの。", anim=0.0,
         speaker=2, face="troubled", speed=1.05, chara="none"),
    Unit("nikai", "では毎年おなじことが起きると、どうなるのだ?", anim=1.4,
         speed=1.05, chara="none"),
    Unit("nikai", "まず1年目の差が、40630円。", anim=0.0,
         speaker=2, speed=1.1, chara="none"),
    Unit("nikai", "2年目の差も、40630円。", anim=0.0,
         speaker=2, speed=1.1, chara="none"),
    ...
    Unit("pat1", "差し引きに使えるのは、小さいほうの10万円までなのだ。", anim=0.0,
         speed=1.05, chara="none"),
    Unit("pat1", "だから差は、20315円になるの。", anim=0.0,
         speaker=2, speed=1.05, chara="none"),
    Unit("pat1", "そして余った損の20万円は、消えて終わりなのだ。", anim=0.0,
         face="troubled", speed=1.05, chara="none"),
    ...
    Unit("jibun", "そして小さいほうに、0.20315をかけるのよ。", anim=0.0,
         speaker=2, speed=1.05),
    Unit("jibun2", "たとえばボクのNISAの損が、4万円だとするのだ。", anim=1.4,
         speed=1.05, chara="none"),
    Unit("jibun2", "同じ年の課税口座の利益が、12万円だとするわね。", anim=0.0,
         speaker=2, speed=1.05, chara="none"),

...
UNITS = [
    ...
    Unit("sousai2", "損した株が、税金を40630円ぶん減らしてくれたのだ。", anim=0.0,
         speed=1.05, chara="none"),
    ...
    Unit("shinkoku", "その申告は、損が出た年から毎年出し続けるのだ。", anim=0.0,
         speed=1.05),
    Unit("shinkoku", "だから1年出し忘れると、権利を失うのだ。", anim=0.0,
    ...
    Unit("te3", "だから売る時期を、税金で決めなくていいのだ。", anim=0.0,
         speed=1.05, chara="none"),
    Unit("te4", "そして4つめ。NISAで買える上限、投資枠の話なのだ。", anim=1.4,
         speed=1.05, chara="none"),
    ...
    Unit("shime", "だからNISAで売っても、税金の話は動かないのだ。", anim=1.4,
         face="smug", speed=1.05),
    Unit("tsugi", "そして税金の20.315%は、概要欄のショートでも見られるのだ。", anim=1.4,
         face="happy", speed=1.1),
    Unit("tsugi", "ショートなら、利益と手取りの図だけを1分で見られるのだ。", anim=0.0,
         speed=1.1),

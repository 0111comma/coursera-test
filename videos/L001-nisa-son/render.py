...
UNITS = [
    ...
    Unit("son", "たとえば株を売って、20万円の損が出たとする。", anim=0.0,
         speed=1.05, intonation=1.25),
    Unit("son", "その損は、消えるだけだと思っていないか。", anim=0.0,
         face="troubled", speed=1.1, intonation=1.2),
    Unit("sousai0", "では同じ年に、別の株で20万円もうけていたとする。", anim=1.4,
         speed=1.05, chara="none"),
    Unit("sousai1", "そのもうけには、ふつう40630円の税金がかかるのだ。", anim=1.4,
         speed=1.05, chara="none"),
    Unit("sousai2", "ところが損と差し引くと、40630円が消えるのだ。", anim=1.6,
         se="impact", se_at=0.32, speed=1.0, intonation=1.3, chara="none"),
    Unit("sousai2", "損した株が、税金を40630円減らしてくれたのだ。", anim=0.0,
         speed=1.05, chara="none"),
    Unit("reigai", "ただし差し引きが使えない口座も、あるのだ。", anim=1.4,
         face="troubled", speed=1.1),
    Unit("sorenisa", "その口座の名前が、NISAなのだ。", anim=1.4,
         se="don", speed=1.0, intonation=1.25),
    Unit("rei2", "NISAで損した年は、40630円を払うのだ。", anim=1.4,
         speed=1.05, chara="none"),
    Unit("yotei", "では4つの章で、条件を確かめていくのだ。", anim=1.4,
         face="happy", speed=1.15, pad=0.6),
    Unit("rei2", "まず消せたはずの40630円を、覚えておくのだ。",
         anim=0.0, speed=1.05, intonation=1.2, chara="none"),

    # ===== 第1章 引けない損(約100〜125秒)
    Unit("ch1", "では第1章。値段の出どころを、確かめていくのだ。", anim=1.4,
         se="pop", speed=1.1),
    Unit("zeiritsu", "まず株や投資信託の利益には、20.315%かかるのだ。", anim=1.4,
         speed=1.1),
    Unit("zeiritsu", "投資信託とは、たくさんの銘柄をまとめた商品のこと。", anim=0.0,
         speed=1.05),
    Unit("uchiwake", "そして20.315%を分けると、所得税と住民税と復興特別所得税になるのだ。", anim=1.4,
         speed=1.05, chara="none"),
    Unit("uchiwake", "うち所得税と住民税で、20%を占めるのだ。", anim=0.0,
         speed=1.05, chara="none"),
    ...
    Unit("kouza", "ちなみに課税口座には、特定口座と一般口座があるのだ。", anim=1.4,
         speed=1.05),
    Unit("gensen", "そして特定口座には、源泉徴収ありという選び方があるのだ。", anim=1.4,
         speed=1.05),
    Unit("gensen", "源泉徴収ありとは、証券会社が代わりに納めてくれること。", anim=0.0,
         speed=1.1),
    ...
    Unit("sashihiki", "課税口座では、損が税金を消す材料になるのだ。", anim=0.0,
         speed=1.05, chara="none"),
    ...
    Unit("riyuu2", "そして損を引けないのは、利益に税金をかけないからなのだ。", anim=0.0,
         speed=1.05),
    Unit("riyuu2", "だから引く相手も、いないのだ。", anim=0.0, speed=1.1),
    ...
    Unit("nen1", "たとえば1年目に、40万円の損が出たとする。", anim=1.4,
         speed=1.05, chara="none"),
    Unit("nen1", "2年目には、40万円の利益を出したとする。", anim=0.0,
         speed=1.05, chara="none"),
    Unit("nen2", "課税口座なら、1年目の損を2年目から引けるのだ。", anim=1.4,
         speed=1.05, chara="none"),
    ...
    Unit("san1", "たとえば毎年10万円の利益なら、3年かけて引いていくのだ。", anim=0.0,
         speed=1.05, chara="none"),
    Unit("san2", "でも3年を過ぎると、余った損はもう引けないのだ。", anim=1.4,
         speed=1.05, chara="none"),
    ...
    Unit("shinkoku", "その申告は、損が出た年から毎年出し続けるのだ。", anim=0.0,
         speed=1.05),
    Unit("shinkoku", "だから一度でも出し忘れると、権利を失うのだ。", anim=0.0,
    ...
    Unit("nikai", "2年目の差も、40630円。", anim=0.0, speed=1.1, chara="none"),
    Unit("nikai", "だから合わせると、81260円になるのだ。", anim=0.0,
         speed=1.05, chara="none", pad=0.6),
    Unit("nikai", "81260円は、消せたはずの税金の2倍なのだ。", anim=0.0,
         se="don", speed=1.0, intonation=1.25, chara="none"),

    # ===== 第3章 効く範囲(約100〜125秒)
    Unit("ch3", "では第3章。差の上限を、額を動かして見るのだ。", anim=1.4,
         se="pop", speed=1.1),
    Unit("onaji", "まず今までの例は、損も利益も同じ額だったのだ。", anim=1.4,
         speed=1.05),
    Unit("onaji", "次に損と利益の額を、動かしてみるのだ。", anim=0.0,
         face="smug", speed=1.1),
    Unit("pat1", "たとえば損が30万円で、利益が10万円の年を考えるのだ。", anim=1.4,
         speed=1.05, chara="none"),
    Unit("pat1", "相殺に使えるのは、小さいほうの10万円まで。", anim=0.0,
         speed=1.05, chara="none"),
    ...
    Unit("jibun2", "余分の計算に使うのは、かけ算だけなのだ。", anim=0.0,
         speed=1.1, chara="none"),
    ...
    Unit("te3", "だから売る時期を、税金で決めなくていいのだ。", anim=0.0,
         speed=1.05, chara="none"),
    Unit("te4", "そして4つめは、売ったあとの投資枠の話。", anim=1.4,
         speed=1.05, chara="none"),
    Unit("te4", "投資枠とは、NISAで買える金額の上限のこと。", anim=0.0,
         speed=1.05, chara="none"),
    Unit("te4", "売って戻る投資枠は、翌年にならないと使えないのだ。", anim=0.0,
         speed=1.05, chara="none"),
    ...
    Unit("kawaru", "ちなみにこの制度は、2026年8月時点の内容なのだ。", anim=1.4,
         speed=1.05),
    Unit("kawaru", "制度は毎年変わるので、見る時期に応じて確かめてほしいのだ。",
    ...
    Unit("matome3", "つまり得も損も、同じ40630円なのだ。", anim=0.0,
         se="don", speed=1.0, intonation=1.25, chara="none"),
    Unit("matome3", "40630円は向きがちがうだけで、額は同じなのだ。", anim=0.0,
         speed=1.05, chara="none"),
    Unit("shime", "だからNISAで売っても、税金の話は動かないのだ。", anim=1.4,
         face="smug", speed=1.05),
    Unit("tsugi", "そして税金の20.315%は、概要欄のショート版でも見られるのだ。", anim=1.4,
         face="happy", speed=1.1),
    Unit("tsugi", "ショート版なら、利益と手取りの図だけを1分で見られるのだ。", anim=0.0,
         speed=1.1),

...
UNITS = [
    ...
    Unit("toi", "給料の口座に、100万円が置いてあるとする。", anim=1.4, speed=1.05),
    Unit("toi", "口座の金利しだいで、利息は変わるのだ。", anim=0.0, speed=1.05),
    Unit("futsu", "まず普通預金の金利は、いま年0.4%だ。", anim=1.6, speed=1.05),
    Unit("futsu", "0.4%だと利息は、年4000円なのだ。", anim=0.0, speed=1.05),
    ...
    Unit("risoku", "1.3%の利息は、年1万3000円なのだ。", anim=0.0, speed=1.05),
    Unit("risoku", "税金を引いても、1万359円が残るのだ。", anim=0.0,
         face="happy", se="impact", se_at=0.30, speed=1.05, intonation=1.2),
    Unit("sa", "1万359円と3187円の差は、7172円。", anim=1.6,
         se="don", speed=1.05, intonation=1.25),
    Unit("sa", "1年で7172円、同じ100万円の置き場所の差。", anim=0.0, speed=1.05),
    Unit("matome", "では7172円が、10年積もるとどうなるか。", anim=1.6,

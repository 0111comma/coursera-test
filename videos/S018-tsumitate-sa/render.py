...
SCENES = {
    ...
    "joken": sc.card("条件", "月1万円を65歳まで", "(増え方は年5%と仮定した場合)", BADGE, BRAND,
                     main_size=52),
    "b25": sc.card("25歳スタート", "約1,526万円", "(元本480万円 → 約3.2倍)", BADGE, BRAND,
                   main_size=56),
    "b35": sc.card("35歳スタート", "約832万円", "(元本360万円 → 約2.3倍)", BADGE, BRAND,
                   main_size=56),
    "gyaku": sc.reveal("元本の差は120万", "なのに結果の差は約694万円", "多く払った120万が694万の差を生む", BADGE, BRAND,
                       size=84),
    "curve": scene_curve,
    ...
    "jigyaku": sc.card("ここだけの話", "10年前のボクに教えたい", "(過去には戻れないのだ)", BADGE, BRAND,
                       main_size=44),
    "hayami": sc.hayami("積立は、始めた歳で3倍違う", [
        ("25歳スタート", "約1,526万円"),
        ("35歳スタート", "約832万円"),
        ("45歳スタート", "約411万円"),
        ("25歳との元本差", "120万円"),
        ("25歳との結果差", "約694万円"),
    ], "月1万円・年5%は仮定・保証なし(自社試算・2026年8月)", BADGE, BRAND, focal=0),
    "chips": sc.chips("あなたは何歳スタート?", ["20代で開始", "30代で開始", "40代以降", "これから"], BADGE, BRAND),
    "loop_back": sc.hero("約694万円", "スタート10年の差(65歳時点・年5%仮定)", BADGE, BRAND,
                         size=104, sub_fs=28),
}
...
UNITS = [
    ...
    Unit("hero_full", "積立を始める年齢、10年の差の値段。", anim=0.8, speed=1.2),
    ...
    Unit("gyaku", "でも多く払った元本は、【120万】だけなのだ。", anim=1.4, face="surprised",
    ...
    Unit("hayami", "スタート年齢べつは、【早見表】なのだ。", anim=0.8, se="pop", speed=1.2),

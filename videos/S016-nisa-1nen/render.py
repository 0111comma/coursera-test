...
UNITS = [
    ...
    Unit("uchiwake", "その59万円が、待っただけで消えるのだ。", anim=0.0, speed=1.05),
    Unit("uchiwake", "では毎月1万円の人なら、どうなるのか。", anim=0.0, speed=1.05),
    Unit("uchiwake", "その差も、およそ32万円になるのだ。", anim=0.0, speed=1.05),
    Unit("matome", "しかもNISAなら、増えた分に税金がかからない。", anim=1.6, speed=1.05),
    Unit("matome", "でもふつうの口座なら、そこから2割が引かれる。", anim=0.0, speed=1.05),
    Unit("matome", "だから待つほど、減るのは増える分なのだ。", anim=0.0, speed=1.05),

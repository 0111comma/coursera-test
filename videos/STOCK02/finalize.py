...
measurement=subprocess.run(['ffmpeg','-hide_banner','-i',str(D/'STOCK02-orukan-leverage.mp4'),'-af','loudnorm=I=-15.5:TP=-1.3:LRA=8:print_format=json','-f','null','-'],capture_output=True,text=True,check=True)

...
SCENES = {
    ...
    "mai_a": sl.barsN("毎月の返済額",
                      [("変動金利", 85036, "8万5036円")], BADGE, BRAND, ymax=140000),
...
UNITS = [
    ...
    Unit("kinri", "固定金利とは、最後まで動かない金利のことよ。", anim=0.0,
         speaker=2, speed=1.05, chara="none"),
    Unit("mai_a", "では変動金利と固定金利で、毎月の返済額を出すわね。", anim=1.4,
         speaker=2, speed=1.05, chara="none"),
    Unit("mai_a", "変動金利なら、毎月8万5036円よ。", anim=0.0,
         speaker=2, speed=1.05, chara="none"),

...
UNITS = [
    ...
    Unit("sougaku", "まず、3000万円を借りるとするのだ。", anim=1.4, speed=1.05, chara="none"),
    Unit("sougaku", "3000万円を、35年かけて返すのよ。", anim=0.0,
         speaker=2, speed=1.05, chara="none"),
    Unit("sougaku", "35年ぶんの総額なら、変動金利で3571万円よ。", anim=0.0,
         speaker=2, speed=1.05, chara="none"),
    Unit("sougaku", "固定金利なら、総額は4948万円なのだ。", anim=0.0, speed=1.05, chara="none"),
    ...
    Unit("sagasu2", "もし5年後に上がるなら、答えは出せるわ。", anim=1.4,
         speaker=2, speed=1.05, chara="none"),
    Unit("sagasu2", "5年後の分かれ目は、3.83%なのだ。", anim=0.0,
    ...
    Unit("uchi1", "利息をのぞくと、借金が減るのは5万9411円よ。", anim=0.0,
         speaker=2, speed=1.05, chara="none"),
    ...
    Unit("zandaka", "そこで、のこる借金も年ごとに見ておくわね。", anim=1.4,
         speaker=2, speed=1.05, chara="none"),
    Unit("zandaka", "まず5年後にのこるのは、2634万円よ。", anim=0.0,
         speaker=2, speed=1.05, chara="none"),
    Unit("zandaka", "では10年たつと、どうなるのだ?", anim=0.0,
         speed=1.05, chara="none"),
    Unit("zandaka", "10年たつと、2250万円までのこりが減るわ。", anim=0.0,
         speaker=2, speed=1.05, chara="none"),
    Unit("zandaka", "では20年たつと、どうなるのだ?", anim=0.0,
         speed=1.05, chara="none"),
    ...
    Unit("ch2", "では第2章。金利が上がると、毎月がどうなるか。", anim=1.4,
         speaker=2, se="pop", speed=1.1),
    Unit("up1", "まず1%上がった場合を、見てみるわね。", anim=1.4,
         speaker=2, speed=1.05, chara="none"),
    Unit("up1", "1%上がると、毎月は9万9764円にふえるわ。", anim=0.0,
         speaker=2, speed=1.05, chara="none"),
    Unit("up1", "毎月で、1万4728円ふえるのだ。", anim=0.0,
         face="troubled", speed=1.05, chara="none"),
    Unit("up1", "1万4728円は、年で17万6742円よ。", anim=0.0,
         speaker=2, se="impact", se_at=0.28, speed=1.05, chara="none"),
    Unit("up1", "17万6742円は、家族旅行が消える額なのだ。", anim=0.0,
         face="troubled", speed=1.05, chara="none"),
    Unit("gonen", "そのふえかたには、決まりがあるの。", anim=1.4,
         speaker=2, speed=1.05),
    Unit("hyaku25", "まず1つめは、5年ごとの見直しなの。", anim=1.4,
         speaker=2, speed=1.05, chara="none"),
    Unit("hyaku25", "5年は据え置きなら、すぐには効かないのだな。", anim=0.0,
         speed=1.05, chara="none"),
    ...
    Unit("hyaku25", "その未払いは、10万6295円で止めたぶんなのよ。", anim=1.4,
         speaker=2, speed=1.05, chara="none"),
    Unit("up1", "では1%上がったまま、35年ぶんを見るわね。", anim=1.4,
         speaker=2, speed=1.05, chara="none"),
    Unit("up1", "その35年ぶんの総額は、4190万円よ。", anim=0.0,
         speaker=2, speed=1.05, chara="none"),
    Unit("up1", "4190万円でも、まだ固定金利の4948万円より安いのだ。", anim=0.0,
         face="happy", speed=1.05, chara="none"),
    ...
    Unit("sagasu2", "ではいますぐ上がるなら、分かれ目は3.14%。", anim=1.4,
         speaker=2, speed=1.05, chara="none"),
    Unit("sagasu2", "3.14%は、いまの固定金利と同じ数字なのだ。", anim=0.0,
         speed=1.05, chara="none"),
    Unit("sagasu2", "3.14%は、5年後に上がるなら3.83%まで動くの。", anim=0.0,
         speaker=2, speed=1.05, chara="none"),
    Unit("sagasu2", "3.83%までなら、変動金利が得な分かれ目なのだ。", anim=0.0,
         face="happy", speed=1.05, chara="none"),
    Unit("sagasu2", "その分かれ目は、10年後に上がるなら4.96%よ。", anim=0.0,
         speaker=2, speed=1.05, chara="none"),
    Unit("sagasu2", "4.96%は、いまの固定金利の1.5倍を超える高さなのだ。", anim=0.0,
         face="surprised", speed=1.05, chara="none"),
    Unit("naze", "その理由は、上がるまでの年に安く返せるからよ。", anim=1.4,
         speaker=2, speed=1.05),
    Unit("naze", "だから安く返したぶんが、貯金になるのだな。", anim=0.0, speed=1.05),
    Unit("kyokusen", "貯金は、5年ぶんで197万円になるの。", anim=1.4,
         speaker=2, speed=1.05, chara="none"),
    Unit("kyokusen", "197万円を先に受け取っているようなものなのだ。", anim=0.0,
         speed=1.05, chara="none"),
    ...
    Unit("katei3", "なので下がらない前提の、きびしめな見方なのだな。", anim=0.0,
         speed=1.05, pad=0.6),
    Unit("sagasu2", "だから3.83%までなら、変動金利が得なのだ。", anim=1.4,
         se="don", speed=1.05, chara="none"),

    # ============ 第4章 逃げ切り + 自分の場合
    Unit("ch4", "では第4章。得になる時期を、あとにずらすわ。", anim=1.4,
         speaker=2, se="pop", speed=1.1),
    Unit("kyokusen", "ずらすと、10年後の分かれ目は4.96%だったわね。", anim=1.6,
         speaker=2, speed=1.05, chara="none"),
    Unit("kyokusen", "4.96%まで耐えられるのは、ずいぶん広いのだ。", anim=0.0,
         face="surprised", speed=1.05, chara="none"),
    Unit("kyokusen", "そして15年後まで上がらなければ、もっと広いわ。", anim=0.0,
         speaker=2, speed=1.05, chara="none"),
    Unit("kyokusen", "15年後なら、6.94%まで耐えられるのだ。", anim=0.0,
         face="surprised", speed=1.05, chara="none"),
    Unit("kyokusen", "そのとおり。遅く上がるほど、分かれ目は上に動くの。", anim=0.0,
         speaker=2, speed=1.05, chara="none"),
    Unit("zandaka", "では、なぜ遅いほど耐えられるのだ?", anim=1.4,
         face="troubled", speed=1.05, chara="none"),
    Unit("zandaka", "それは、10年後にはのこりが2250万円だからよ。", anim=0.0,
         speaker=2, speed=1.05, chara="none"),
    ...
    Unit("hyo", "自分の年数の行を見れば、耐えられる%が分かるのだ。", anim=0.0,
         speed=1.05, chara="none"),
    Unit("tejun", "その行の見つけ方を、3つの手順にするわね。", anim=1.4,
         speaker=2, speed=1.05, chara="none"),
    Unit("tejun", "まず借入額と年数を、明細で確かめるのだ。", anim=0.0,
         speed=1.05, chara="none"),
    Unit("tejun", "年数を決めたら、表の行を見るのよ。", anim=0.0,
         speaker=2, speed=1.05, chara="none"),
    Unit("tejun", "そして分かれ目まで耐えられるかを、考えるのだ。", anim=0.0,

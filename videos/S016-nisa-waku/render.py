...
UNITS = [
    Unit("fueta", "積み立てた株が、増えていたとする。", anim=1.0, cover=True,
    ...
    Unit("ne0", "そしてそれが、150万円になったとする。", anim=0.0,
         speed=1.05),
    Unit("ne0", "そこで売っても、税金はかからないのだ。", anim=0.0,
         face="troubled", speed=1.05),
    Unit("ne1", "まず戻ってくるのは、売った150万円ではないのだ。", anim=1.6,
         speed=1.05),
    Unit("ne1", "その枠は、買った100万円で戻るのだ。", anim=0.0,
    ...
    Unit("son", "ちなみに値下がりして売ると、逆のことが起きるのだ。", anim=1.6,
         speed=1.05),
    Unit("son", "その80万円で売っても、枠は100万円のまま。", anim=0.0,
         speed=1.05),

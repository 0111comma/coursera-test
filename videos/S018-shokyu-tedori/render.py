...
SCENES = {
    ...
    "shime": sc.chips("あなたの昇給は?",
                      ["額面で見ていた", "手取りで見ていた", "今年上がった", "上がっていない"],
                      BADGE, BRAND),
}
...
UNITS = [
    ...
    Unit("agaru", "たとえばその給料が、1万円上がったとする。", anim=1.4, speed=1.05),
    Unit("agaru", "その1万円が、そのまま手元に来ると思うか。", anim=0.0,
         face="troubled", speed=1.05),
    Unit("shaho", "まず引かれるのが、社会保険料なのだ。", anim=1.6, speed=1.05),
    Unit("shaho", "その保険料は、健康保険と年金などのこと。", anim=0.0, speed=1.05),
    Unit("shaho", "それが1469円、先に引かれるのだ。", anim=0.0,
         se="impact", se_at=0.30, speed=1.05, intonation=1.2),
    Unit("shaho", "だから残るのは、8531円になるのだ。", anim=0.0, speed=1.05),
    Unit("zei", "そしてその残りに、税がかかるのだ。", anim=1.6, speed=1.05),
    Unit("zei", "その税のうち所得税が、871円なのだ。", anim=0.0, speed=1.05),
    Unit("zei", "そしてもう一つの税が、853円の住民税。", anim=0.0, speed=1.05),
    Unit("kekka", "だから手元に増えるのは、6807円。", anim=1.6,
         face="surprised", se="don", speed=1.05, intonation=1.25),
    Unit("kekka", "つまり3193円は、消えているのだ。", anim=0.0, speed=1.05),
    Unit("kekka", "その割合は、およそ3割になるのだ。", anim=0.0, speed=1.05),
    Unit("kekka", "だから2倍上がっても、消える割合は同じなのだ。",
         anim=0.0, speed=1.05),
    Unit("matome", "しかもいま2026年は、年収が上がるほど引かれる。", anim=1.6,
         speed=1.05),
    Unit("matome", "だから上がった額だけでは、手取りは分からない。", anim=0.0, speed=1.05),

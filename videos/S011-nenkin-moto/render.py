...
SCENES = {
    ...
    "shurui": sc.bars2("年金は2つある",
                      ("自分で払う人", 1, "国民年金"),
                      ("会社員", 2, "＋厚生年金"),
                      BADGE, BRAND, ymax=2.3),
    "naze": sc.card("いつからいつまで", "20歳から60歳", "(そう決まっている)",
                    BADGE, BRAND, main_size=58, head_fs=34),
    "mangaku": sc.card("これは満額の場合", "抜けがない人の額", "(抜けた月があると減る)",
...
UNITS = [
    ...
    Unit("shurui", "その年金には、2つの種類があるのだ。", anim=1.2, face="happy",
         speed=1.15, intonation=1.2),
    Unit("dare", "まずは自分で払う、国民年金で見るのだ。", anim=1.2, speed=1.15),
    Unit("hokenryo", "その保険料は、いま月1万7920円。", anim=1.4, speed=1.15),
    Unit("naze", "これを20歳から、60歳になるまで払う。", anim=1.4, speed=1.15),
    Unit("yonjunen", "つまり40年間、払い続けることになる。", anim=1.6, speed=1.15),
    ...
    Unit("mangaku", "ただしこれは、1度も抜けずに払った人の額。", anim=1.4, speed=1.15),
    Unit("nenkan", "その額を年に直すと、およそ85万円。", anim=1.4, speed=1.15),

...
SCENES = {
    ...
    "kijun": sc.card("何が厳しくなるか", "地場産品の基準", "※ 告示が改正されました",
                     BADGE, BRAND, main_size=72, head_fs=32,
                     ask="あなたの欲しい品は、加工品ですか?"),
...
UNITS = [
    Unit("aki", "ふるさと納税は、年末でいいと思っていないか。", anim=1.0,
         cover=True, se="pop", speed=1.05, intonation=1.25),
    Unit("aki", "でもそのふるさと納税に、10月の区切りがあるのだ。", anim=1.4,
         face="troubled", speed=1.05),
    Unit("kijun", "その月から、返礼品の基準が変わるのだ。", anim=1.4, speed=1.05),
    Unit("kijun", "その基準とは、その土地の品かを見る決まり。", anim=0.0,
         speed=1.05),
    Unit("kakou", "まず加工品には、証明が要るようになるのだ。", anim=1.4, speed=1.05),
    Unit("kakou", "その証明とは、地元産が半分より多いか。",
         anim=0.0, speed=1.05),
    Unit("logo", "そして名前だけ地元の品も、絞られるのだ。", anim=1.4,
         speed=1.05),
    Unit("logo", "その品は、1年以内に売れた数まで。", anim=0.0,
    ...
    Unit("kawaranai", "まず返礼品にかける額は、3割のままなのだ。", anim=0.0,
         speed=1.05),
    Unit("kawaranai", "そして募集にかける額も、5割のままなのだ。",
         anim=0.0, speed=1.05),

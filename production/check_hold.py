...
# 「300か月」「16年」も、視聴者が頭に持つ答えの数字。**円・歳・%だけでは足りない**
# (2026-08-23。S032が「300か月」を後半に置いたのに前半で出切った判定になった。
#  全32本で判定が変わるのはS032だけであることを確かめてから広げた)
MONEY = re.compile(r"[0-9][0-9,万億]*(?:円|歳|%|か月|ヶ月|年)")
LATE = 0.60

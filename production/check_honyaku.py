...
# ---- T4 冗長な述部
# 2026-09-07 日本語パネル5周目: 「上司の発言を変えることはできない」が素通りした。
# 「ことができ」しか見ていなかったので、否定形の「ことはできない」「ことができない」や
# 丁寧形の「ことができます」が漏れる。**語幹「ことが/ことは + でき」で見る**
T4 = ["ことができ", "ことはでき", "ことも可能", "ことが可能", "において", "に関して", "というもの",
